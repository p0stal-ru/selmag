...
public class ClientConfig {
    ...
    public WebClient.Builder selmagServicesWebClientBuilder(
            ...
            ObservationRegistry observationRegistry // здесь(38)
    ) {
        ...
        return WebClient.builder()
                // с помощью данных методов, можем указывать соответствующие компоненты для сбора трассировок
                // где observationRegistry можем получать из контекста приложения(30стр)
